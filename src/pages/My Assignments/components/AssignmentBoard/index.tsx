...
const AssignmentBoard: React.FC<AssignmentBoardTypes.Props> = ({
    ...
    return (
        ...
        >
            <AssignmentBoardHeader status={status} isMobile={isMobile} openColumns={openColumns} toggleColumn={toggleColumn}>
                <AssignmentBoardTitle status={status} isMobile={isMobile} openColumns={openColumns}>{title}</AssignmentBoardTitle>

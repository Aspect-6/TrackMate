...
const AssignmentBoardAssignmentCount: React.FC<AssignmentBoardTypes.Header.AssignmentCountProps> = ({ status }) => {
    ...
    const getColors = () => {
        switch (status) {
            case 'To Do': return { header: MY_ASSIGNMENTS.HEADER_TEXT_TODO, border: MY_ASSIGNMENTS.COUNT_BORDER_TODO };
            case 'In Progress': return { header: MY_ASSIGNMENTS.HEADER_TEXT_INPROGRESS, border: MY_ASSIGNMENTS.COUNT_BORDER_INPROGRESS };
            case 'Done': return { header: MY_ASSIGNMENTS.HEADER_TEXT_DONE, border: MY_ASSIGNMENTS.COUNT_BORDER_DONE };
            default: return { header: MY_ASSIGNMENTS.TEXT_PRIMARY, border: MY_ASSIGNMENTS.BORDER_LIGHT };
        }
    };

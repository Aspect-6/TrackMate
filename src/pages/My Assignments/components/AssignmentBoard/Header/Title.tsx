...
const AssignmentBoardTitle: React.FC<AssignmentBoardTypes.Header.TitleProps> = ({ status, children, isMobile, openColumns }) => {
    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold" style={{ color: headerColor }}>{children}</h2>
        </div>
    );
};
